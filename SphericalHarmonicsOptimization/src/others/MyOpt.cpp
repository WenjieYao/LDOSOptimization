...
#define MAX_ITER 1                            // maximum number for number of coeff sets 
...
const unsigned int num_coeffs = 16+1;           // number of coefficients
...
int min_mesh = 200;
int max_mesh = 350;
double resolution = 0.2;                        // resolution, larger the finer, default 1
